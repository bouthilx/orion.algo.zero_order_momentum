#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Installation script for `orion.algo.zero_order_momentum`."""
import os
...
setup_args = dict(
    name='orion.algo.zero_order_momentum',
    version=versioneer.get_version(),
    cmdclass=versioneer.get_cmdclass(),
    description='TODO',
    long_description=open(os.path.join(repo_root, "README.rst")).read(),
    license='BSD-3-Clause',
    author=u'Thomas George, Xavier Bouthillier',
    author_email='xavier.bouthillier@umontreal.ca',
    url='https://github.com/bouthilx/orion.algo.zero_order_momentum',
    packages=['orion.algo.zero_order_momentum'],
    package_dir={'': 'src'},
