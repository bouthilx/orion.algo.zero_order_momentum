# -*- coding: utf-8 -*-
#
# orion.algo.zero_order_momentum documentation build configuration file.
#
...
import orion.algo.zero_order_momentum as algo_plugin
...
project = u'orion.algo.zero_order_momentum'
...
htmlhelp_basename = 'zero_order_momentumdoc'
...
latex_documents = [
  (master_doc, 'orion.algo.zero_order_momentum.tex',
   u'Oríon algo zero_order_momentum Documentation',
   u'Thomas George, Xavier Bouthillier', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'zero_order_momentum',
   u'Oríon algo zero_order_momentum Documentation',
   author, 'zero_order_momentum', algo_plugin.__descr__,
   'Miscellaneous'),
]
